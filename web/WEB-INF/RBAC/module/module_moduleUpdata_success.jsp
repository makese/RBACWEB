...
<div class="row">
  <div class="col-md-3 pull-left">
    <div class="panel panel-default panel-actions">
      ...
      <div class="list-group"> <a href="module/module_queryModule" class="list-group-item active" > 返回 </a> </div>
    </div>
   </div>
    ...
    <div class="col-md-9 pull-right">
      <form method="post" action="module/module_updataModule" >
        <div class="row">
          <div class="col-sm-12">
            <div class="form-group col-sm-6 pull-left">
              <label class="control-label">模块名</label>
              <input type="hidden" name="module.id" value="${moduleup.id}" >
              <input type="text" name="module.moduleName" class="form-control"  value="${moduleup.moduleName}">
            </div>
          </div>
        </div>
        <div class="form-group text-center">
          <input class="btn btn-primary" type="submit" name="save" value="修改模块">
