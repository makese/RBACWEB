  ...
  <div class="row">
    <div class="col-md-9 pull-right">
      ...
      <div class="panel panel-default">
		...
		<a class="list-group-item" href="roles/role_save">添加角色</a>	
    ...
    <div class="col-md-9 pull-right">
      <table id="example" class="table table-bordered table-hover">
        ...
        <tr>
            <td><input type="checkbox" name="boxname" value="${roles.id}"/></td>
            <td>${roles.roleName}</td>
			<td>
				<s:iterator  value="#roles.roleFunction"  var="functions">   
               		${functions.functionName}
       			</s:iterator> 
			</td>
			<td>
				<a href="roles/role_roleUpdata?role.id=${roles.id}&role.roleName=${roles.roleName}">修改</a> 
			</td>
			<td>
				<a href="roles/role_deleteRole?role.id=${roles.id}" onclick="return confirmit()" >删除</a>
			</td>
			<td>
				<a href="roles/role_roleFunction?role.id=${roles.id}">添加功能</a> 
			</td>
       	</tr>
		</s:iterator> 
        </tbody>
