  ...
  <div class="container">
	...
	<div class="col-md-6 pull-left">
      <table id="example" class="table table-bordered table-hover">
        ...
        <tbody>
		<s:iterator value="role.roleFunction"  var="functions">
        <tr>
            <td>${functions.functionName}</td>
			<td>
				<a href="roles/role_roleDeleteFunction?role.id=${role.id}&function.id=${functions.id}">删除功能</a> 
			</td>
       	</tr>
		</s:iterator> 
        </tbody>
    ...
    <div class="col-md-6 pull-right">
      <table id="example1" class="table table-bordered table-hover">
        ...
        <tbody>
		<s:iterator value="#session.functionList"  var="functions">
        <tr>
            <td>${functions.functionName}</td>
			<td>
				<a href="roles/role_roleAddFunction?role.id=${role.id}&function.id=${functions.id}">添加功能</a> 
			</td>
       	</tr>
		</s:iterator> 
        </tbody>
